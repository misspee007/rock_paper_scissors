...
export default function App() {
  ...
  const [gameState, setGameState] = useState(null); // win, lose or draw
  ...
  function renderIconComponent(choice) {
        ...
        <div className={`game-state ${gameState}`}>
          <div>
            <div className="game-state-content">
              <p>{renderIconComponent(userChoice)}</p>
              {gameState === "win" && <p>Congrats! You won!</p>}
              {gameState === "lose" && <p>Sorry! You lost!</p>}
              {gameState === "draw" && <p>Oops! It's a draw!</p>}
              <p>{renderIconComponent(computerChoice)}</p>
            </div>
